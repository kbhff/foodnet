# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-25 17:47
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='payment',
            name='status',
            field=models.CharField(choices=[('unpaid', 'unpaid'), ('paid-cash', 'paid-cash'), ('paid-mobile', 'paid-mobile'), ('canceled', 'canceled')], default='unpaid', max_length=15, null=True),
        ),
        migrations.AddField(
            model_name='payment',
            name='user',
